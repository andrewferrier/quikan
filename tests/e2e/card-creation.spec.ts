...
test.describe('card creation', () => {
  test('clicking the column "+" button opens a dialog with title "Add Todo"', async ({ page }) => {
    await page.goto('/');
  ...
  test('creating a todo with summary only appears in Todo (No Due Date)', async ({ page }) => {
    await page.goto('/');
    await page.locator('[data-testid="column-todo"] [data-testid="add-task-btn"]').click();
  ...
  test('creating a todo from the Today column pre-fills today and appears in Todo (Today)', async ({ page }) => {
    await page.goto('/');
    await page.locator('[data-testid="column-todo-today"] [data-testid="add-task-btn"]').click();
  ...
  test('creating a todo from the Tomorrow column pre-fills tomorrow and appears in Todo (Tomorrow)', async ({ page }) => {
    await page.goto('/');
    await page.locator('[data-testid="column-todo-tomorrow"] [data-testid="add-task-btn"]').click();
